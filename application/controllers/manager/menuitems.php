...
class MenuItems extends CI_Controller {
	...
	{
		$this->data['res_menuitems'] = $this->menuitems->get_all_restro_menuitems();
		$this->data['res_menuitems_name'] = $this->menuitems->get_all_restro_menuitems();
	...
	public function bar_add()
	{
		...
		if ($this->form_validation->run() == FALSE){
			...
			//insert the menu item into the database
			$menuitemid = $this->menuitems->insert_menuitem($ingredients,'bar');
