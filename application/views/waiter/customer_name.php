		...
		<div class="container-fluid" style="margin-top:120px;">	
			<div class="welcome-outer rounded-6px">
				<div class="welcome-inner rounded-4px">
					<h4 style="">Welcome to Saffron Restaurant!</h4>
					...
					<form id="welcomeform_name" method="post" action="<?php echo site_url('waiter/customer_name/setname'); ?>">
						...
						<div style="" class="control-group">
							...
							<div class="controls">
								<input type="text" id="basicCalculator" class="input-xlarge validate[required, custom[onlyNumberSp]], maxSize[4], minSize[4]" value="" name="key" /><br/>
							</div>
						</div>
					</form>
