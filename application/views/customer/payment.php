						...
						<div class="paymentordercontent">
							...
							<?php foreach ($unpaid_items as $unpaid_item): ?>
								<div class="ordereditem">
									...
									<div class="ordered pull-left" style=""><?php echo $unpaid_item->name; ?><br/><b><?php echo $currency .' : '. $unpaid_item->price; ?></b></div>
								</div>
							<?php endforeach; ?>
						</div>
								...
								<p>
									<table class="form">
										<tr>
											...
											<td><span id="subtotalamount"><?php echo   $currency .' : '. $values->subtotal; ?></span></td>
										</tr>
										<tr>
											<td class="formlabel">Tax</td>
											<td><span id="taxamount"><?php echo   $currency .' : '. $values->tax; ?></span> <input type="hidden" value="<?php echo $values->tax; ?>" name="tax" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span id="totalamount"><?php echo  $currency .' : '. $values->total; ?></span> <input name="total" type="hidden" value="<?php echo $values->total; ?>" /></td>
										</tr>
										<tr>
				...
				<div class="span3 outer-frame rounded-6px">
					<div class="wincoupon rounded-4px" style="">
						...
						<div class="wincouponcontent">
							<p>Did you enjoy your meal at Restaurant? Do you want a free coupon? Click the button below 
