...
function hide()
{
       ...
       document.getElementById("search").style.display = "none";
			...
			$(document).ready(function(){
				...
				$('#min_limit').on('keydown',function(e){
    var deleteKeyCode = 8;
				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                            	...
                            	<form class="form-horizontal" id="tablesetupform" name="form1" method="post" action="<?php echo site_url('kitchen/ingredients/EditIngName'); ?>">
						...
						<input type="hidden" id="id" value="<?php echo $id; ?>" class="" name="id" />
							...
							<div class="controls">
								<input type="text" id="min_limit" value="<?php echo $min_ingr; ?>" class="" name="min_limit"/>
								</div>
								
								<br>
							<label class="control-label" for="tabletnumber">Type</label>
					<div class="controls">
					<select onclick="hideoption()" style="background-color: #ffffa0" name="ing_type" required>
				     
				     <option id="a" value="<?php echo $ing_type; ?>" selected ><?php echo $ing_type;?> <= Selected</option>
				      ...
				      <option value="grm">Gram</option>
						...
						<div class="form-actions nobottomspace" style="padding-left:0;text-align:center;background-color:inherit;border-color:#99A2B6">
							...
							&nbsp;&nbsp;&nbsp;
									...
									<a href="<?php echo site_url('kitchen/ingredients'); ?>" class="btn btn-danger transition">Cancel</a>
