            ...
            <div id="page-inner">
				...
				<div class="panel panel-default">
                        ...
                        <ul class="nav nav-pills">
								<li id="today_li" class="active"><a type="0" href="#" onclick="get_today()" class="">Today's Added</a></li>
								<li id="all_li" ><a type="1" onclick="get_all()" href="#" class="">Available Stock </a></li>
