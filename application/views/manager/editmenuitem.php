				...
				<div class="span12 rounded-6px">
					<div class="whitebg">
						...
						<div class="singlecontent padding-10px">
							<form id="menuitemform" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('manager/menuitems/edit/' .base64_encode($menuitem->id)); ?>">
