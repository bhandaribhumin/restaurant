				...
				<div class="span12 outer-frame rounded-6px">
					<div class="whitebg">
						...
						<div class="singlecontent padding-10px">
							<form id="itemform" class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('manager/ingredients/add'); ?>">
								<div style="margin-bottom:25px;overflow:auto;">
									<table class="form pull-left" style="width:50%;margin-right:20px;">
										<tbody>
											<tr>
												<td class="formlabel label20">Ingredient</td>
								...
								<div class="form-actions">
									<a href="#" onclick="$('#itemform').submit()" class="btn btn-large">Add Ingredients</a>
									&nbsp;&nbsp;
									<a href="<?php echo site_url('manager/ingredients'); ?>" class="btn btn-large transition">Cancel</a>
								</div>
							</form>
						</div>
					</div>
