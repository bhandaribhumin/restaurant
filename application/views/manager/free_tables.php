...
background-size:90% 67%; background-repeat:no-repeat;background-position: center; pointer-events:<?php if(in_array($i,$used_table_array)) echo "none;"?><?php if(!in_array($i,$used_table_array)) echo "auto;"?>background-color:<?php if(in_array($i,$used_table_array)) echo "#".$configruation->occupied_table_notify_color;?>" >
