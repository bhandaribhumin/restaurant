  ...
  <style>
    ...
    <select id="select4" name="select4" multiple required>
      <optgroup label="" class="group_one">
        <?php foreach ($this->data['menuitems'] as $menu) {?>
          
        <option value="<?php echo $menu['item_no'];?>" class="option_one" data-subtitle="<?php echo $menu['name'];?>" ><?php echo $menu['item_no'];?></option>
        <?php }?>
      </optgroup>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="order_placed_msg">Order has been Placed, Wana Genrate Kot..?</h4>
