				...
				<div class="span12 rounded-6px">
					<div class="whitebg">
						...
						<div class="singlecontent padding-10px">
							<form id="menuitemform" class="form-horizontal" name="menuitemform" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('manager/menuitems/restro_add'); ?>">
								<div style="margin-bottom:25px;overflow:auto;">
									...
									<table class="form pull-left" style="width:50%;margin-right:2px;">
										<tbody>
											...
											<tr>
												<td for="inputName" class="formlabel label20">Item No</td>
												<td><input type="number"  id="inputName"  name="item_no" placeholder="Item No" required></td>
												<td></td>
											</tr>
											...
											<tr>
												<td for="inputCount" class="formlabel label20">Calories Count</td>
												<td><input  id="inputCount" type='number' step='.01' name="calories" required placeholder="Numeric Value Only"/></td>
											</tr>
											<tr>
										...
										<div id="container">
									      <div id="content">
										      <div class="side-by-side clearfix">
										        <div>
													<select id="ingredients" name='ingredients[]'  class="chosen-select" multiple required style="width:350px;" tabindex="4">
													...
													<select name="type" required>
														...
														<?php
													      foreach ($menutypes as $menutype) {
													        echo "<option value='".$menutype->id."'>".$menutype->menutype_name."</option>";
													        # code...
													      }
											...
											<tr>
												...
												<td>
													<select name="res_category" required>
														<option value="BH" selected>Saffron </option>
