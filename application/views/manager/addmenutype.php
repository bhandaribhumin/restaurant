				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                       			<form id="itemform" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('manager/menutype/add'); ?>">
								<div style="margin-bottom:25px;overflow:auto;">
									
									<div class="control-group">
							    	<label for="menuType"  class="control-label">Menu Type</label>
								    <div class="controls">
										    <input type="text"  id="menuType"  name="menutype_name" placeholder="Menu Type" required>
									</div>
								  </div>
