				...
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                       			<form class="form-horizontal" id="tablesetupform1" name="form1" method="post"
						

					 	action="<?php echo site_url('manager/inventory/add/' . base64_encode($id)); ?>"
					...
					<label class="control-label" for="tabletnumber">Available Quantity</label>
							...
							<div class="controls">
								<a class="btn btn-info"  onclick="processadd()" >Add </a> &nbsp;&nbsp;&nbsp;
								 ...
								 <a class="btn btn-danger" href="<?php echo site_url('manager/inventory'); ?>" > Cancal</a>
							</div>
							<br>
						...
						<div id="save" class="form-actions nobottomspace" style="display:none; padding-left:0;text-align:center;background-color:inherit;border-color:#99A2B6">
							<a class="btn btn-info"onclick="$('#tablesetupform1').submit()" id="save"  class="btn  transition">Save</a>&nbsp;&nbsp;
