				...
				<div class="span12 rounded-6px">
					<div class="whitebg">
						...
						<div class="singlecontent padding-10px">
							<form id="menuitemform" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('manager/menuitems/edit_bar/' .base64_encode($menuitem->id)); ?>">
										...
										<div id="container">
									      <div id="content">
										      <div class="side-by-side clearfix">
										        <div>
													<select name='ingredients[]' data-placeholder="Choose a Ingredients ..." class="chosen-select" multiple style="width:350px;" tabindex="4" required>
