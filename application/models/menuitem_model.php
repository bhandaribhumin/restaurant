...
class menuitem_model extends CI_Model{
    ...
    public function get_all_restro_menuitems()
    {
        $query = $this->db->query("SELECT * from menuitem where category='restro'");
        return $query->result();
    }

     public function get_all_bar_menuitems()
    {
        $query = $this->db->query("SELECT * from menuitem where category='bar'");
        return $query->result();
    }
    ...
    public function get_item_name($item_no){
        ...
        $query=$this->db->query("Select name,id,price from menuitem where item_no=".$item_no);        
        return $query->row();
    }
