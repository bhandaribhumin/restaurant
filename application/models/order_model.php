...
class order_model extends CI_Model{
    ...
    public function add_order($tablenumber=null,$waiter_id=null,$customer_name=null,$mobile_no=null){
    ...
    public function get_tablenumber_by($customer_unique_id){
     ...
     public function get_tablenumber_by_order($orderid){
       $query=$this->db->query("SELECT tablenumber from `order` where id='".$orderid."'");
        return $query->row_array();
